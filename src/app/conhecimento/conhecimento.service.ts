...
export class ConhecimentoService {
  ...
  private endPoint : string = 'conhecimento';
  ...
  novo(conhecimento: any) {
    return this.http.post(env.apiUri + this.endPoint, conhecimento).toPromise();
  }
  ...
  atualizar(conhecimento: any) {
    return this.http.put(env.apiUri + this.endPoint, conhecimento).toPromise();
  }
