...
export class HabilidadeFormComponent implements OnInit {
  ...
  async addIcon (icone) {
    ...
    //selectedOption.innerHTML = 'src= "../img/{{icone.viewValue}}"';
    console.log(icone);
    console.log(icone.idIcone);
    console.log(icone.idIcone.url);
    //console.log(icone[0].idIcone);
  ...
  async ngOnInit() {
    ...
    try{
      this.icones = await this.talentoSrv.listar();
