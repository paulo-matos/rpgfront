...
export class HabilidadeService {
  ...
  */
  ...
  novo(habilidade: any) {
    return this.http.post(env.apiUri + this.endPoint, habilidade).toPromise();
  }
  ...
  atualizar(habilidade: any) {
    return this.http.put(env.apiUri + this.endPoint, habilidade).toPromise();
  }
